...
refs.form.addEventListener("input", (0, _lodashThrottleDefault.default)(storageValue), 500);
saveLocalStorage();
...
function saveLocalStorage() {
    ...
    if (parsData) {
        for(const key in parsData)if (parsData.hasOwnProperty(key)) {
...
function onFormSubmit(e) {
    e.preventDefault();
    if (refs.textarea.value === "" || refs.input.value === "") return alert("Please fill in all the fields!");
    e.currentTarget.reset();
    localStorage.removeItem("STOREG_KEY");
}

},{"lodash.throttle":"bGJVT","../css/03-feedback.css":"lNqQd","../css/common.css":"97fCK","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"bGJVT":[function(require,module,exports) {
var global = arguments[3];
/**
...
},{}],"lNqQd":[function() {},{}],"97fCK":[function() {},{}],"gkKU3":[function(require,module,exports) {
